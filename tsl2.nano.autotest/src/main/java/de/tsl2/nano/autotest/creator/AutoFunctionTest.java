...
public class AutoFunctionTest {
	...
	public void testFunctions() {
		...
		if (o1 != null && o1.getClass().isArray())
			...
			assertEquals(tester.toString(), o1, o2);
		}
	}

	private void assertAnyArrayEquals(Object o1, Object o2) {
		if (o1.getClass().getComponentType() == byte.class)
			assertArrayEquals(tester.toString(), (byte[])o1, (byte[])o2);
		else if (o1.getClass().getComponentType() == char.class)
			assertArrayEquals(tester.toString(), (char[])o1, (char[])o2);
		else if (o1.getClass().getComponentType() == short.class)
			assertArrayEquals(tester.toString(), (short[])o1, (short[])o2);
		else if (o1.getClass().getComponentType() == int.class)
			assertArrayEquals(tester.toString(), (int[])o1, (int[])o2);
		else if (o1.getClass().getComponentType() == float.class)
			assertArrayEquals(tester.toString(), (float[])o1, (float[])o2, DELTA_FLOAT);
		else if (o1.getClass().getComponentType() == double.class)
			assertArrayEquals(tester.toString(), (double[])o1, (double[])o2, DELTA_DOUBLE);
		else
			assertArrayEquals(tester.toString(), (Object[])o1, (Object[])o2);
	}
}

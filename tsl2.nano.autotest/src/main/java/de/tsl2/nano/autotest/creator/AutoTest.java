...
public enum AutoTest implements IPreferences {
	DONTTEST, FORBIDSYSTEMEXIT, DUPLICATION(9), PARALLEL, TIMEOUT(100), PRECHECK_TWICE(true), TESTNEVERFAIL, FILENAME("autotest/generated/generated-expectations-"), 
	FAST_CLASSSCAN, CLEAN, FILTER(""), MODIFIER(-1), 

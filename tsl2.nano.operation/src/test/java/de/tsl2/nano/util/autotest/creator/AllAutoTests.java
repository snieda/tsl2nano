...
import de.tsl2.nano.util.operation.ComparationOperator;
...
public class AllAutoTests {
	public static void init() {
		System.setProperty("tsl2.functiontest.filter", matchPackage(ComparationOperator.class, SParser.class));
	}
}

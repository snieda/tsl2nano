...
public class PolyglottFitnessFunction implements Function<Long[], Double> {
    ...
    public PolyglottFitnessFunction() {
        ...
        if (scriptFile == null) {
            ...
            throw new IllegalArgumentException("Please define java property 'polyglott.fitnessfunction.language' and 'polyglott.fitnessfunction.script'\n\tThe script may access the variable 'intput' of type Long[] ");
        }

...
import static de.tsl2.nano.terminal.TextTerminal.SCREEN_HEIGHT;
import static de.tsl2.nano.terminal.TextTerminal.SCREEN_WIDTH;
import static de.tsl2.nano.terminal.TextTerminal.getTextFrame;
...
public class SIShell implements IItemHandler, Serializable {
    ...
    static Properties createEnvironment(String name, Map definitions) {
        ...
        Properties env = FileUtil.userDirFile(p).canRead() ? FileUtil.loadPropertiesFromFile(p) : new Properties();
        if (definitions != null) {

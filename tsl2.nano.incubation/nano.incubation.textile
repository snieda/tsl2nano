...
This project/plugin contains base technology implementations to be evaluated for future use in _swartifex.common_
...
If you change sources of this plugin, you should start ant script _eclipse-tsl2.nano.incubation.xml_ with target _swartifex.eclipse.incubation.export_ and after that the 'deploy' target of your main project.

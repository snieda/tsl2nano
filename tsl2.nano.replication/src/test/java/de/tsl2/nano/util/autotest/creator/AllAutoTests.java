...
public class AllAutoTests {
	public static void init() {
		set(FILTER, matchPackage(EntityReplication.class));
		set(FILTER_EXCLUDE, StringUtil.matchingOneOf(methods(SerializeSimpleXml.class, "deserialize"),
				SerializeBytes.class, "deserialize"));
	}
}

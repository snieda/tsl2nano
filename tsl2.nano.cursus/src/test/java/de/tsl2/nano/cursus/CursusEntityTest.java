...
import de.tsl2.nano.cursus.persistence.EConsiliumID;
import de.tsl2.nano.cursus.persistence.EExsecutio;
import de.tsl2.nano.cursus.persistence.EGrex;
import de.tsl2.nano.cursus.persistence.EMutatio;
import de.tsl2.nano.cursus.persistence.EObsidio;
import de.tsl2.nano.cursus.persistence.EProcess;
import de.tsl2.nano.cursus.persistence.ERes;
import de.tsl2.nano.cursus.persistence.ERuleEffectus;
import de.tsl2.nano.cursus.persistence.ETimer;
...
public class CursusEntityTest implements Serializable /* only for the inner-classes */ {
	...
	public void testProcess() {
		...
		EConsilium eConsilium = new EConsilium(new EConsiliumID("test-change"), "test",
				new ETimer(DateUtil.getYesterday(), DateUtil.getTomorrow()), Priority.NORMAL, eExsecutio);
	...
	public void testAnnotations() {
		...
		entities.stream().filter(e -> e.isAnnotationPresent(Entity.class) && !e.equals(ERuleEffectus.class))
				.forEach(e -> checkEntity(e));
	...
	public void testProcessActions() {
		...
		checkAction(EProcess.class, "resetto", "Reset To", "icons/reload.png",
				MapUtil.asMap("LastActiveConsilium", EConsilium.class));
	}

	private void checkAction(Class entity, String actionName, String actionLabel, String iconPath,
	...
	private void checkAnnotation(Class<?> entity, String beanAttribute, String property,
			Class<? extends Annotation> annotationCls, String annAttribute) {

...
//    public static final String TAG_FONT = "font";
    ...
    public static final String STYLE_BACKGROUND_RADIAL_GRADIENT =
        "background: var(--bg-color); background-size: cover;";
    ...
    public static String templateStyles() {
        if (tableDivStyle == null) {
            ...
            ENV.get("layout.tablewrap.width", "640");
    ...
    public static Element createSidebarNavMenuButton(Element parent, Element sidenav) {
        ...
        //return "<span style=\"font-size:30px;cursor:pointer\" onclick=\"openNav()\">&#9776; open</span>"; //☰=\u2630, &#8801; â‰¡
        //âœ– = &#10006; or &times;
        //✘ 10008   2718

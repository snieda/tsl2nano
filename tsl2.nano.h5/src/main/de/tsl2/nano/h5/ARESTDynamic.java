...
public abstract class ARESTDynamic<RESPONSE> {
	...
	RESPONSE serve(String url, String method, Map<String, String> header, Map<String, String> parms, Map<String, String> payload, boolean internalCall) {
		try {
			return doServe(url, method, header, parms, payload, internalCall);
	...
	protected RESPONSE doServe(String url, String method, Map<String, String> header,
			Map<String, String> parms, Map<String, String> payload, boolean internalCall)
	...
	String printManual() {
		return 
				...
				+ "\n\tapi                 : prints the open-api yaml of resources NanoJAXRS and NanoBackendJaxrs"

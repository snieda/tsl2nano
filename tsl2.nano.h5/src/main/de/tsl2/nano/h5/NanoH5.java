...
//                }
    ...
    protected void extractJarScripts() {
        try {
            ...
            ENV.extractResource("presentation/frame/left-panel.frm");
            ENV.extractResource("presentation/frame/right-panel.frm");
            ENV.extractResource("presentation/frame/menu-actions.frm");

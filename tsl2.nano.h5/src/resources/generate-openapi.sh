...
if [[ $GENERATE_SPEC != "" ]]; then
	...
	cp -frv --update=all generated-src/src/main/java/org generated-src
	rm -frv generated-src/src/main/java/org
	cp -frv --update=all generated-src/src/test/java/org generated-src
	rm -frv generated-src/src/test/java/org

	# make them persistable
...
#	sed -i -E 's/(public class.*)/@javax.persistence.Entity\n\1\n\n\t\/\/generated by tsl2nano\n\tprivate @javax.persistence.Id @javax.persistence.GeneratedValue Long idgen_;\n/g' \
#		$(find generated-src/org/openapitools/client/model -name "*.java" -a -not -name "*Test.java")
	sed -i -E 's/(private Object)/@javax.persistence.Transient\n\t\1/g' \
		$(find generated-src/org/openapitools/client/model -name "*.java" -a -not -name "*Test.java")

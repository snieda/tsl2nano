...
%JAVA% %OFFLINE% %LANG% %USERDIR% %NANO_DEBUG% %AGENT% %PROXY% -Xmx512m -Djava.awt.headless=true  -file.encoding=UTF-8 %DEBUG% %UH% -jar tsl2.nano.h5.1.1.0%STANDALONE%.jar %PRJ% %PORT% 

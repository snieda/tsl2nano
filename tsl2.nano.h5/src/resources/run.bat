...
if "%3"=="debug" (set DEBUG="-agentlib:jdwp=transport=dt_socket,address=8787,server=y,suspend=y")
...
rem @start javaw
java  %USERDIR% %NANO_DEBUG%  -Xmx512m -Djava.awt.headless=true %DEBUG% -jar tsl2.nano.h5.0.6.0.jar %PRJ% %PORT% 

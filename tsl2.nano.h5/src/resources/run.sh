...
java $OFFLINE $UH $LLANG $ENCODING $JSU_ENC $USERDIR $NANO_DEBUG $AGENT $PROXY -Xmx512m -Djava.awt.headless=true -Dfile.encoding=UTF-8 $DEBUG $UH -jar tsl2.nano.h5-$VERSION$STANDALONE.jar $PRJ $PORT 

...
-- Comment for table [Organisation]: root definition - may be used for different clients;
...
-- Comment for table [Classification]: items level;
...
-- Comment for table [Category]: combines a group of areas. may be useless on some use cases;
...
-- Comment for table [Area]: an area combines a group of item types;
...
-- Comment for table [Type]: item type;
...
-- Comment for table [ChargeItem]: mapping between party and charge - resolving a many-to-many relation. a party will charge items.;
...
-- Comment for table [Party]: may be a person, client, reservation item like a restaurant table etc.;
...
-- Comment for table [Property]: extended optional properties for main entries like an organisation, party or item.
-- 
...
-- Comment for table [Location]: location of a party. can have an address or a coordinate;
...
-- Comment for table [Charge]: agreement, booking or reservation;

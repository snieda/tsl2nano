...
Each bean and each bean-attribute can define a layout and layout-constraints through it's presentable object. It is easy to do layout definitions programmatically through the BeanPresentationHelper, but in this chapter we describe only the xml configuration.

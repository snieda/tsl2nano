...
* OpenJPA    : _org.apache.openjpa.persistence.PersistenceProviderImpl_
* EclipseLink: _org.eclipse.persistence.jpa.PersistenceProvider_
* TopLink    : _oracle.toplink.essentials.PersistenceProvider_
* Acme Pers. : _com.acme.persistence_
* DataNucleus: _org.datanucleus.api.jpa.PersistenceProviderImpl_
...
The O/R mappers *EBean* and *ORMLite* are able to work on JPA-annotations, but no *javax.persistence.EntityManager* was implemented. So, the nano.h5 framework is useless on android systems at this moment.
...
* speichern von Konfigurationen mit nullpointer in privateaccessor
* spalten-layout tag: section (landscape, portrait)

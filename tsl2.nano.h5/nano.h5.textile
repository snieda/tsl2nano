...
Using the style _embed_ would embed the whole attachment content into the html response file. all other styles only reference the given source file with an _src_ attribute.

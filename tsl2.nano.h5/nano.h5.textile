...
Other smaller frameworks provide only access to JPA-Annotations without providing an EntityManager:
...
** datanucleus: metamodel has to be statically generated and compiled before
...
* konfig format
* Expectable-Data?
* TAGs: bean2html, entity2html, bean2gui, entity2gui, jpa2gui, jpa2html, jpa persistence provider, openjpa, hibernate, datanucleus, eclipselink, data-editor, data-sheet, entity browser, jpa2, framework
* use maven to get the desired jars in environment directory (Environment.loadExternalDependencies)

* extrahieren der jars ueber konstanten

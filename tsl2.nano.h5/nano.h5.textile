...
The _Controller_ is an extension of _BeanCollector_ to present a collection of beans through their actions. These actions should be ease change-actions for attributes - like de- or increasing their values. This feature should be used for touch-screen applications.
...
* jpa: was, wenn collection-joincolumn nullable = false?

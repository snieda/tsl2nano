...
- Everything will filled for you by defaults - presenting a full application getting a database connection
...
* handling blobs of data (byte[]) to be presented in html
* planned interfaces: 
...
public class MyApp extends NanoH5 {
	...
	protected BeanDefinition<?> createBeanCollectors(@SuppressWarnings("rawtypes") List<Class> beanClasses) {
        ...
        /*
         * using value-groups to show nested beans in sub-panels
         */
         bean.valueGroups = new LinkedList<ValueGroup>();
         bean.valueGroups.add(new ValueGroup("test", bean.getAttributeNames()));
         ValueGroup group = new ValueGroup("sub");
         group.add("persons", true);
         bean.valueGroups.add(group);

		//save/serialize bean/beancollector definitions to xml        

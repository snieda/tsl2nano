...
//        }
    ...
    public void testCollectionUtil() throws Exception {
        ...
        Assert.assertEquals(Arrays.asList("1", "11", "101", "111", "1100", "Anton", "Berta", "Carsten0", "Carsten1", "Hans Mueller", "Hans Müller"), sortedList);
        
        //3. filtering data
        Collection<String> filteredBetween = CollectionUtil.getFilteringBetween(list, "Anton", "Carsten1");
        Assert.assertEquals(Arrays.asList("Anton", "Berta", "Carsten0", "Carsten1"), CollectionUtil.getList(filteredBetween.iterator()));
    ...
    public void testSimpleDateFormat() throws Exception {
        Format df = RegularExpressionFormat.createDateRegExp();
        String valid[] = { "0",
            "1",
            "2",
            "3",
...
//        }
    ...
    public void testCurrency() throws Exception {
        final Format f = RegularExpressionFormat.createCurrencyRegExp();
        LOG.info(f);
...
//        LOG.info(amount.getNumber());
    ...
    public void testBeanUtils() throws Exception {
        ...
        assertArrayEquals(args, MapUtil.asArray(BeanUtil.toValueMap(tbm, "", false, false,
        "primitiveBoolean",
        "primitiveByte",
        "primitiveChar",
        "primitiveShort",
       ...
       /*
        ...
        //TODO: which serialization algorithm to use? providing all default constructors?
...
//        assertTrue(BeanUtil.equals(beandef.getAttributes(), beandefFromXml.getAttributes()));
    ...
    public void testValueExpression() throws Exception {
         ...
         */
        ValueExpression<TypeBean> ve = new ValueExpression("printf:%string$10s-%primitiveInt$2d==>%primitiveShort$2d", TypeBean.class);
        TypeBean tb = new TypeBean();
//        tb.setString("test");

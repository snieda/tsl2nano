...
A base plugin for all swartifex plugins to hold common libraries and code. There are no dependencies to eclipse and swt plugins to be usable on server side.
...
* rename project to be independent of swartifex
...
* _eclipse-tsl2.nano.common.xml_ with target _swartifex.eclipse.common.export_ (Please be sure to use the same jre-runtime as your eclipse-workspace - otherwise nothing will be done!).

...
import de.tsl2.nano.maven.generator.GeneratorMojo;

@RunWith(Suite.class)
@SuiteClasses({InitAllAutoTests.class, AutoFunctionTest.class, CurrentStatePreservationTest.class})
public class AllAutoTests {
	public static void init() {
		System.setProperty("tsl2.functiontest.filter", matchPackage(GeneratorMojo.class));
		// set(FILTER, matchMethod(GeneratorMojo.class, "execute"));
	}
}

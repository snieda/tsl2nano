...
public class Persistence implements Serializable {
    ...
    private void saveJdbcProperties() throws IOException {
        ...
        prop.store(new FileWriter(new File(getPath(FILE_JDBC_PROP_FILE))), "Property file generated by nano.directaccess");
    }
    ...
    protected String savePersistenceXml() throws IOException {
        ...
        Environment.saveBackup(FILE_MYPERSISTENCE);
    ...
    public static Persistence current() {
        Persistence p;
        if (Persistence.exists()) {
            p = Environment.get(XmlUtil.class).loadXml(getPath(FILE_MYPERSISTENCE_BEAN),
                Persistence.class);
        } else {
            p = new Persistence();
        }

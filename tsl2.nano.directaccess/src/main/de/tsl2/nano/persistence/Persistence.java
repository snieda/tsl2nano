...
public class Persistence implements Serializable {
    ...
    public String save() throws IOException {
        FileUtil.removeToBackup(getBackupPath(getBeanFileName()));
    ...
    private void saveJdbcProperties() throws IOException {
        ...
        FileUtil.removeToBackup(getBackupPath(FILE_JDBC_PROP_FILE));
    ...
    protected String savePersistenceXml() throws IOException {
        ...
        FileUtil.removeToBackup(getBackupPath(FILE_MYPERSISTENCE));
    ...
    protected void addPersistenceProperties(Persistence parent, Map<String, Object> prop) {
        ...
        prop.put("jar-file", jarFileInEnvironment());
    ...
    /**
     * the bean-jar must be in the class-path: this has to be inside the environment directory.
     * jarFileInEnvironment
     * @return
     */
    public String jarFileInEnvironment() {
        return Environment.getConfigPath() + new File(getJarFile()).getName();
    }
